...
import cc.rits.membership.console.iam.usecase.admin.email.SendEmailUseCase;
...
@RestController
@RequestMapping(path = "/api/admin/email", produces = MediaType.APPLICATION_JSON_VALUE)
@Validated
